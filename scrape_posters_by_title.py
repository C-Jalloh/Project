...
def main():
    ...
    # Get only movies without images
    cursor.execute("SELECT id, title, release_year FROM movies WHERE image_url IS NULL OR image_url = ''")
    ...
    for movie in movies:
        ...
        if poster_url:
            ...
            # Use movie title as filename for easier identification
